            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                {
                    TRENDING_PRODUCTS.map((product) => (
                        <ProductTileCard key={product.id} id={product.id} name={product.name} price={product.price} rating={product.rating} reviews={product.reviews} image={product.image} badge={product.badge} />
                    ))
                }
            </div>
        </section>
