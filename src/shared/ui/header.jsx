...
const Header = ({ searchQuery = "", setSearchQuery, onSearch }) => {
    ...
    const routeForQuery = (rawQuery) => {
        ...
        navigate(`/community?q=${encodeURIComponent(trimmedQuery)}`, { replace: true });
    };
        ...
        <header className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white/95 backdrop-blur-sm">
            <div className="mx-auto flex h-16 max-w-360 items-center justify-between px-4 sm:px-6 lg:px-8 gap-4">
                ...
                <div className="hidden md:flex flex-1 max-w-2xl px-4">
                    <Search onChange={handleChange} value={searchQuery} onSearch={handleSearch} />
                </div>
                <div className="flex items-center gap-2 sm:gap-4 shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <IconButton icon="shopping_cart" className={"relative"}>
